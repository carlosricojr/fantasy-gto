...
const buttonVariants = cva(
  // Not `transition-all`. This is the most-used component in the app, and `all` includes
  // every layout property — so a variant that changes padding, a label that changes width,
  // or an icon that appears animates the geometry of the button and everything after it in
  // the row. Only the four properties a button actually changes on hover, focus and
  // disable are transitioned; none of them is a motion property, so this needs no
  // `motion-safe:` guard.
