...
unknown board players, and attempts to replace an already matched pick are rejected. A future
UI can persist those repair records beside draft history without mutating history itself.
