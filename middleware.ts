 ...
 * the lineup optimizer are deliberately open: the product's argument is that value should
 ...
 * wall.
 *
 * This is presentation-level routing, not authorization. Every privileged operation is
