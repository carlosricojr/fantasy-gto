 ...
 * one the measured model cannot support: the real edge over a strong baseline is 2.29%
      ...
      <section className="mx-auto max-w-3xl px-6 py-12">
        <div className="rounded-lg border p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            projections beat a season-average baseline by <strong>2.29%</strong> in mean
